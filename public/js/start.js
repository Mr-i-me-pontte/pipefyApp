...
PipefyApp.initCall({
    ...
    'card-tab': function (p, pipe) {
        return {
            icon: './images/icon-blue.svg', title: 'Ações do Contrato', 
            buttons: [{
                text: 'Gerar .docx', callback: function (p) {
            ...
            {
                text: 'Criar CCI', callback: function (p) {
                    p.card().then(function ({title}) {
    ...
    //             p.dropdown({
    //                 title: 'Emoji app', items: [{
    //                     title: '🤔 Open flags Sidebar', callback: openSidebar,
    //                 }, {
    //                     title: '🙈 Open emojis Modal', callback: openModal,
    //                 }, {
    //                     title: '✅ Show success notification', callback: function (p) {
    //                         p.showNotification('🎉 Sample success notification', 'success');
    //                         p.closeDropdown();
    //                     },
    //                 }, {
    //                     title: '❌ Show error notification', callback: function (p) {
